...
/**
 * **************************************************************************** Compilation: mvn
 * package Execution: java -cp
 * target/fftw-convolution-1D-example-0.0.1-SNAPSHOT-jar-with-dependencies.jar main.java.Server
 *
...
public class ConvolutionExample {
  ...
  private static double[] fftw_convolve(double[] a, double[] b) {
    ...
    PrintHelpers.printDoublePointer(
        fft_b.get_output_pointer(),
        2 * fft_b.output_size); // in C++ code this was print_complex_array
    System.out.println();
    ...
    // fft_b.get_output_as_complex_array()));
